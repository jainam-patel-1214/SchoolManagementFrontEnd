                ...
                <div>
                    ...
                    {urole === "teacher" ?
                        <StyledNavbarTabs>
                            Exams
                            <StyledNavbarSubTabs>
                                <NavbarTabs style={{ marginTop: "10px" }} onClick={() => {handleNavigation("/app/teacher") }}>Add Marks</NavbarTabs>
                                <LineBreak />
                                <NavbarTabs style={{ marginBottom: "10px" }} onClick={()=>{handleNavigation("searchSubject")}}>Edit Marks</NavbarTabs>
                            </StyledNavbarSubTabs>
                        </StyledNavbarTabs> : <></>
                    }
